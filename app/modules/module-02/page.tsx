...
import { AlertTriangle, BookOpen, Cable, CircuitBoard, ShieldCheck, Wrench, Zap, Building, CloudLightning, Flame, Target, Waypoints, GitBranch, Ruler, Brain, Plug } from "lucide-react";
...
export default function ModulePage() {
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section className={`mx-auto max-w-5xl mb-12 transition-all duration-1000 delay-1300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div>
            ...
            <div className="space-y-4 text-gray-300">
              <p><HL>250.50</HL>: Grounding electrode system must include water pipe, metal building frame, concrete-encased electrode, ground ring, or made electrodes.</p>
              <p><HL>250.66</HL>: GEC sizing based on largest ungrounded service conductor: 6 AWG for 100A, 4 AWG for 200A, 2 AWG for 400A.</p>
              <p><HL>250.122</HL>: EGC sizing based on OCPD rating, not conductor size. 14 AWG for 15A, 12 AWG for 20A, 10 AWG for 30A.</p>
              <p><HL>250.53</HL>: Concrete-encased electrode minimum 20 feet in length, 2 inches from edge, encased in concrete.</p>
              <p><HL>250.104</HL>: Water pipe bonding required within 5 feet of entrance, sized per 250.66 table.</p>
            </div>
      ...
      {/* Article 280/285 — Surge Arresters & SPDs */}
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-white">Articles 280/285 — Surge Arresters & SPDs</h2>
            </div>
            
            <div className="space-y-4 text-gray-300">
              <p><HL>280.4</HL>: Surge arresters rated for system voltage, installed on line side of service disconnect.</p>
              <p><HL>285.3</HL>: SPDs installed on load side, coordinated with surge arresters for complete protection.</p>
              <p><HL>285.6</HL>: SPDs must be listed for purpose, installed per manufacturer instructions.</p>
              <p><HL>285.11</HL>: SPDs require proper grounding and bonding connections for effective operation.</p>
            </div>
