...
import { AlertTriangle, BookOpen, Cable, CircuitBoard, ShieldCheck, Wrench, Zap } from "lucide-react";
      ...
      <section className={`mx-auto max-w-5xl mb-12 transition-all duration-1000 delay-3000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
          <div className="bg-white/[0.03] rounded-xl border border-white/20 p-6 text-center">
            <div className="w-12 h-12 bg-yellow-400/20 rounded-lg flex items-center justify-center mx-auto mb-4"><Zap className="w-6 h-6 text-yellow-400" /></div>
          ...
          <div className="bg-white/[0.03] rounded-xl border border-white/20 p-6 text-center">
            <div className="w-12 h-12 bg-yellow-400/20 rounded-lg flex items-center justify-center mx-auto mb-4"><Cable className="w-6 h-6 text-yellow-400" /></div>
          ...
          <div className="bg-white/[0.03] rounded-xl border border-white/20 p-6 text-center">
            <div className="w-12 h-12 bg-yellow-400/20 rounded-lg flex items-center justify-center mx-auto mb-4"><ShieldCheck className="w-6 h-6 text-yellow-400" /></div>
