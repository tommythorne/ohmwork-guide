...
// Quiz data - 15 questions about Chapter 1: Wiring and Protection
const quiz: Q[] = [
  {
    id: 1,
    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white">
      ...
      <section className="relative h-96 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <h1 className="text-5xl font-bold text-white mb-4">Chapter 1 — Wiring and Protection</h1>
      ...
      <section className={`mx-auto max-w-5xl mb-12 transition-all duration-1000 delay-1400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-white mb-4">Chapter 1 Summary</h2>
      ...
      <section className={`mx-auto max-w-5xl mb-12 transition-all duration-1000 delay-1500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-lg">Test your understanding of Chapter 1</p>
        </div>
